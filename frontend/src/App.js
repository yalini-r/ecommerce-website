...
function App() {
  return (
    ...
    <Routes>
        ...
        <Route path='/mens' element ={<ShopCategory bnr={men_bnr} category="men"/>}/>
        <Route path='/womens' element ={<ShopCategory bnr={women_bnr} category="women"/>}/>
        <Route path='/kids' element ={<ShopCategory bnr={kids_bnr}  category="kid"/>}/>
